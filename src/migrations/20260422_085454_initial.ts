...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`blog_posts_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`blog_posts_blocks_image_section_order_idx\` ON \`blog_posts_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`blog_posts_blocks_image_section_parent_id_idx\` ON \`blog_posts_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`blog_posts_blocks_image_section_path_idx\` ON \`blog_posts_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`blog_posts_blocks_image_section_locale_idx\` ON \`blog_posts_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`blog_posts_blocks_image_section_image_idx\` ON \`blog_posts_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`blog_posts_cover_image_idx\` ON \`blog_posts_locales\` (\`cover_image_id\`,\`_locale\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_blog_posts_v_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_blog_posts_v_blocks_image_section_order_idx\` ON \`_blog_posts_v_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_blog_posts_v_blocks_image_section_parent_id_idx\` ON \`_blog_posts_v_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_blog_posts_v_blocks_image_section_path_idx\` ON \`_blog_posts_v_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_blog_posts_v_blocks_image_section_locale_idx\` ON \`_blog_posts_v_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`_blog_posts_v_blocks_image_section_image_idx\` ON \`_blog_posts_v_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_blog_posts_v_version_version_cover_image_idx\` ON \`_blog_posts_v_locales\` (\`version_cover_image_id\`,\`_locale\`);`)
  ...
  await db.run(sql`CREATE TABLE \`use_case_pages_workflow_steps\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`use_case_pages_workflow_steps_order_idx\` ON \`use_case_pages_workflow_steps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_workflow_steps_parent_id_idx\` ON \`use_case_pages_workflow_steps\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_workflow_steps_locale_idx\` ON \`use_case_pages_workflow_steps\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`use_case_pages_testimonials\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`use_case_pages_testimonials_order_idx\` ON \`use_case_pages_testimonials\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_testimonials_parent_id_idx\` ON \`use_case_pages_testimonials\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_testimonials_locale_idx\` ON \`use_case_pages_testimonials\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_testimonials_avatar_idx\` ON \`use_case_pages_testimonials\` (\`avatar_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`use_case_pages_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`use_case_pages_blocks_image_section_order_idx\` ON \`use_case_pages_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_blocks_image_section_parent_id_idx\` ON \`use_case_pages_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_blocks_image_section_path_idx\` ON \`use_case_pages_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_blocks_image_section_locale_idx\` ON \`use_case_pages_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`use_case_pages_blocks_image_section_image_idx\` ON \`use_case_pages_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_use_case_pages_v_version_workflow_steps\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_workflow_steps_order_idx\` ON \`_use_case_pages_v_version_workflow_steps\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_workflow_steps_parent_id_idx\` ON \`_use_case_pages_v_version_workflow_steps\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_workflow_steps_locale_idx\` ON \`_use_case_pages_v_version_workflow_steps\` (\`_locale\`);`)
  await db.run(sql`CREATE TABLE \`_use_case_pages_v_version_testimonials\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_testimonials_order_idx\` ON \`_use_case_pages_v_version_testimonials\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_testimonials_parent_id_idx\` ON \`_use_case_pages_v_version_testimonials\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_testimonials_locale_idx\` ON \`_use_case_pages_v_version_testimonials\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_version_testimonials_avatar_idx\` ON \`_use_case_pages_v_version_testimonials\` (\`avatar_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_use_case_pages_v_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_blocks_image_section_order_idx\` ON \`_use_case_pages_v_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_blocks_image_section_parent_id_idx\` ON \`_use_case_pages_v_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_blocks_image_section_path_idx\` ON \`_use_case_pages_v_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_blocks_image_section_locale_idx\` ON \`_use_case_pages_v_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`_use_case_pages_v_blocks_image_section_image_idx\` ON \`_use_case_pages_v_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_use_case_pages_v_locales\` (
  	...
  	\`version_workflow_eyebrow\` text,
  	\`version_workflow_title\` text,
  	\`version_workflow_description\` text,
  	\`version_testimonials_eyebrow\` text,
  	\`version_testimonials_title\` text,
  ...
  await db.run(sql`CREATE TABLE \`privacy_page_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`privacy_page_blocks_image_section_order_idx\` ON \`privacy_page_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`privacy_page_blocks_image_section_parent_id_idx\` ON \`privacy_page_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`privacy_page_blocks_image_section_path_idx\` ON \`privacy_page_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`privacy_page_blocks_image_section_locale_idx\` ON \`privacy_page_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`privacy_page_blocks_image_section_image_idx\` ON \`privacy_page_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_privacy_page_v_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_privacy_page_v_blocks_image_section_order_idx\` ON \`_privacy_page_v_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_privacy_page_v_blocks_image_section_parent_id_idx\` ON \`_privacy_page_v_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_privacy_page_v_blocks_image_section_path_idx\` ON \`_privacy_page_v_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_privacy_page_v_blocks_image_section_locale_idx\` ON \`_privacy_page_v_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`_privacy_page_v_blocks_image_section_image_idx\` ON \`_privacy_page_v_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`terms_page_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`terms_page_blocks_image_section_order_idx\` ON \`terms_page_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`terms_page_blocks_image_section_parent_id_idx\` ON \`terms_page_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`terms_page_blocks_image_section_path_idx\` ON \`terms_page_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`terms_page_blocks_image_section_locale_idx\` ON \`terms_page_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`terms_page_blocks_image_section_image_idx\` ON \`terms_page_blocks_image_section\` (\`image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_terms_page_v_blocks_image_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_terms_page_v_blocks_image_section_order_idx\` ON \`_terms_page_v_blocks_image_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_terms_page_v_blocks_image_section_parent_id_idx\` ON \`_terms_page_v_blocks_image_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_terms_page_v_blocks_image_section_path_idx\` ON \`_terms_page_v_blocks_image_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_terms_page_v_blocks_image_section_locale_idx\` ON \`_terms_page_v_blocks_image_section\` (\`_locale\`);`)
  await db.run(sql`CREATE INDEX \`_terms_page_v_blocks_image_section_image_idx\` ON \`_terms_page_v_blocks_image_section\` (\`image_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`blog_posts_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`_blog_posts_v_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`use_case_pages_workflow_steps\`;`)
  await db.run(sql`DROP TABLE \`use_case_pages_testimonials\`;`)
  ...
  await db.run(sql`DROP TABLE \`use_case_pages_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`_use_case_pages_v_version_workflow_steps\`;`)
  await db.run(sql`DROP TABLE \`_use_case_pages_v_version_testimonials\`;`)
  ...
  await db.run(sql`DROP TABLE \`_use_case_pages_v_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`privacy_page_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`_privacy_page_v_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`terms_page_blocks_image_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`_terms_page_v_blocks_image_section\`;`)
